...
function clickLeft() {
  ...
  switch (newValue) {
    case -270:
      ...
      document.querySelector('.project2-container').removeAttribute('aria-hidden', "true");
      break;
    case 0:
      document.querySelector('.project4').setAttribute('tabindex', '-1');
      document.querySelector('.project4-container').setAttribute('aria-hidden', "true");
      document.querySelector('.project1').removeAttribute('tabindex');
      document.querySelector('.project1-container').removeAttribute('aria-hidden', "true");
      break;
    default:
      break;
  }
...
function validateForm(e) {
  ...
  if (nameField.value === "") {
    document.getElementById('name-error').innerHTML = "! Para eviar el formulario se ocupa un nombre";
  } else {
    showNotification();
  }
}
...
//Esta escucha la clave para cerrar el modal
